      ...
      <div class="row-group">
        <div class="join-row">
          <div class="input-box icon-id">
            <input v-model="joinData.userId" type="text" placeholder="아이디" class="join-input">
            <span class="input-suffix">@naver.com</span>
          </div>
        </div>
        <div class="join-row">
          <div class="input-box icon-pw">
            <input v-model="joinData.userPw" type="password" placeholder="비밀번호" class="join-input">
          </div>
        </div>
        <div class="join-row">
          <div class="input-box icon-mail">
            <input v-model="joinData.email" type="text" placeholder="[선택] 이메일주소 (비인증용)" class="join-input">
          </div>
        </div>
      </div>
...
.row-group { border: 1px solid #dadada; background: #fff; margin-bottom: 12px; border-radius: 6px; }
.join-row { padding: 15px; border-bottom: 1px solid #dadada; }
